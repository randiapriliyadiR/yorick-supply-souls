...
# USTEC M15 chart — original VIDEO baseline (Risk 2%, SlowMax 1.0, Guard 1.0R).
$ErrorActionPreference = "Stop"
$tester = $PSScriptRoot
$run = Join-Path $tester "run_backtest.ps1"
$csv = Join-Path $tester "health_tune_pro_ustec_video_m15.csv"
...
function Run-One {
  ...
  $args = @{
    Symbol = "USTEC_ExnessPro"; Period = "M15"; TrendTF = "H4"; TrendOnZoneTf = "false"
...
Run-One -Name "pustM_base" -Notes "M15 video risk2 zones M15"
Run-One -Name "pustM_zh1" -Notes "zones M15,H1" -ZoneTFs "M15,H1" -SkipCompile
Run-One -Name "pustM_slow08" -Notes "slow0.8" -SlowMaxAtr 0.8 -SkipCompile
Run-One -Name "pustM_slow12" -Notes "slow1.2" -SlowMaxAtr 1.2 -SkipCompile
Run-One -Name "pustM_soff" -Notes "slow OFF" -RequireSlow "false" -SkipCompile
Run-One -Name "pustM_slx15" -Notes "slx1.5" -SlZoneMult 1.5 -SkipCompile
Run-One -Name "pustM_slx25" -Notes "slx2.5" -SlZoneMult 2.5 -SkipCompile
Run-One -Name "pustM_atroff" -Notes "atr OFF" -UseAtrRegime "false" -SkipCompile
Run-One -Name "pustM_guard05" -Notes "guard 0.5R" -BeTriggerR 0.5 -TrailStartR 0.5 -TrailDistR 0.5 -SkipCompile
Run-One -Name "pustM_rr15" -Notes "minRR1.5" -RequireMinRr "true" -MinRiskReward 1.5 -SkipCompile
