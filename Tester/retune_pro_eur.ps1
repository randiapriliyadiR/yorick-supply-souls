...
$csv = Join-Path $tester "health_tune_pro_eur.csv"
...
function Run-One {
  param(
    ...
    $SlowMaxAtr = 0.7, $RequireSlow = "true",
    $RequireFvg = "true",
  ...
  $args = @{
    Symbol = "EURUSD_ExnessPro"; Period = "M5"; TrendTF = "H4"; TrendOnZoneTf = "false"
...
# Gold Pro defaults lose on EUR — explore filters/SL/impulse (not SlowMax-only)
Run-One -Name "peur_base" -Notes "goldPro defaults"
Run-One -Name "peur_slow05" -Notes "slowMax0.5" -SlowMaxAtr 0.5 -SkipCompile
Run-One -Name "peur_slow06" -Notes "slowMax0.6" -SlowMaxAtr 0.6 -SkipCompile
Run-One -Name "peur_slowoff" -Notes "slow OFF" -RequireSlow "false" -SkipCompile
Run-One -Name "peur_fvgoff" -Notes "fvg OFF" -RequireFvg "false" -SkipCompile
Run-One -Name "peur_slx25" -Notes "slx2.5" -SlZoneMult 2.5 -SkipCompile
Run-One -Name "peur_slx30" -Notes "slx3.0" -SlZoneMult 3.0 -SkipCompile
Run-One -Name "peur_slx15" -Notes "slx1.5" -SlZoneMult 1.5 -SkipCompile
Run-One -Name "peur_atroff" -Notes "atr OFF" -UseAtrRegime "false" -SkipCompile
Run-One -Name "peur_atr175" -Notes "atr 1.75" -AtrRegimeMult 1.75 -SkipCompile
Run-One -Name "peur_imp15" -Notes "impulse1.5 body0.8" -ImpulseAtrMult 1.5 -BodyAtrMult 0.8 -SkipCompile
Run-One -Name "peur_imp10" -Notes "impulse1.0 body0.5" -ImpulseAtrMult 1.0 -BodyAtrMult 0.5 -SkipCompile
Run-One -Name "peur_guard10" -Notes "guard 1.0R" -BeTriggerR 1.0 -TrailStartR 1.0 -TrailDistR 1.0 -SkipCompile
Run-One -Name "peur_rr20" -Notes "minRR 2.0" -RequireMinRr "true" -MinRiskReward 2.0 -SkipCompile
Run-One -Name "peur_slx25_imp15" -Notes "slx2.5+imp1.5" -SlZoneMult 2.5 -ImpulseAtrMult 1.5 -BodyAtrMult 0.8 -SkipCompile
Run-One -Name "peur_slowoff_slx25" -Notes "slowOFF+slx2.5" -RequireSlow "false" -SlZoneMult 2.5 -SkipCompile
